...
User Story 2
As a user, I want to navigate to the Lägg till bok page so that I can add a new book.

User Story 3
As a user, I want to navigate to the Mina Böcker page so that I can see my favorite books.
...
User Story 8
As a user, I would like to be prevented from adding a book when required fields are empty so that I don’t create incomplete entries.
